package com.healthnutrition.security
	...
	override fun doFilterInternal(
		...
		if (!authHeader.isNullOrBlank() && authHeader.startsWith("Bearer ")) {
			...
			try {
				...
				val authorities = listOf(SimpleGrantedAuthority(claim.role))
				val authentication = UsernamePasswordAuthenticationToken(claim.accountId, null, authorities)
